...
{?>
   ...
   <?php } ?>
                            ...
                            <td>
                               <b> Registration Number: </b><?php echo htmlentities($_SESSION['login']);?><br>
                               <b> Student Name: </b>  <?php echo htmlentities($row['studentname']);?><br>
                               <b> Student Registration Date:</b> <?php echo htmlentities($row['studentregdate']);?><br>
                                <b> Student Course Enrollment Date:</b> <?php echo htmlentities($row['edate']);?><br>
                            </td>
                        </tr>
                    </table>
                </td>
